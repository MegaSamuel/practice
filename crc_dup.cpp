...
void combination(std::vector<std::string>& dict, std::string str, unsigned n, uint32_t hash)
{
    ...
    for (unsigned i = 0; i < dict[n].size(); ++i) {
        combination(dict, str+dict[n][i], n+1, hash);
    }
}
...
{
{
    ...
    dict.push_back("abcdefghijklmnopqrstuvwxyz");
    dict.push_back("abcdefghijklmnopqrstuvwxyz");
    dict.push_back("abcdefghijklmnopqrstuvwxyz");
    dict.push_back("abcdefghijklmnopqrstuvwxyz");
    dict.push_back("abcdefghijklmnopqrstuvwxyz");
